...
export default function Home() {
  ...
  const { welcomeMessage, Features,herocontent,button1,button2 } = content;
  return (
    <main >
    ...
    <Image class="d-block mx-auto mb-4" src="/docs/5.3/assets/brand/bootstrap-logo.svg" alt="" width="72" height="57"/>
    <h1 class="display-5 fw-bold text-body-emphasis">{welcomeMessage}</h1>
    <div class="col-lg-6 mx-auto">
      <p class="lead mb-4">{herocontent}</p>
      <div class="d-grid gap-2 d-sm-flex justify-content-sm-center">
        <button type="button" class="btn btn-primary btn-lg px-4 gap-3">{button1}</button>
        <button type="button" class="btn btn-outline-secondary btn-lg px-4">{button2}</button>
      </div>
    </div>
  </div>
    </div>
